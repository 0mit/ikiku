...
resources are employed by the businesses they are placed with.
    ...
    'version': '19.0.0.1.8',
    'license': 'AGPL-3',
    'depends': ['base', 'mail', 'portal', 'search_suggest', 'place_ir'],
    'data': [
        'security/ikiku_groups.xml',
        'security/ir.model.access.csv',
        'security/ikiku_rules.xml',
        'data/ikiku_place_data.xml',
        'data/ikiku_season_data.xml',
        'data/ikiku.knowledge.scheme.csv',
        'data/ikiku.knowledge.class.csv',
        'data/ikiku.spec.node.csv',
        'data/ikiku.spec.requirement.csv',
        'data/ikiku.knowledge.link.csv',
        'data/ikiku.spec.country.rule.csv',
        'data/ikiku_spec_data.xml',
        'data/ikiku_work_type_data.xml',
