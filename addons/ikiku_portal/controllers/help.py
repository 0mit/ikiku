...
PLAIN_FIELDS = {
    ...
    ('res.partner', 'place_id'): None,
    ('res.partner', 'place_path'): None,
    ('res.partner', 'place_public_id'): "شهر، یا محله اگر خودتون انتخاب کنید",
    ('res.partner', 'place_visibility'): None,
    ('res.partner', 'place_city_id'): None,
    ('res.partner', 'place_province_id'): None,
    ('res.partner', 'place_hint'): None,
    ...
    ('ikiku.demand', 'place_public_id'): "شهر، یا محله اگر مجموعه انتخاب کرده باشه",
    ('ikiku.demand', 'place_id'): None,
    ('ikiku.demand', 'place_path'): None,
    ('ikiku.demand', 'place_city_id'): None,
    ('ikiku.demand', 'place_province_id'): None,
    ('ikiku.demand', 'place_hint'): None,
    ...
    ('ikiku.business', 'place_public_id'): "شهرِ مجموعه، یا محله‌اش اگر خودتون انتخاب کنید",
    ('ikiku.business', 'public_name'): "اسمِ مجموعه، فقط اگه خودتون بخواید",
    ('ikiku.business', 'place_visibility'): None,
    ('ikiku.business', 'name_public'): None,
    ('ikiku.demand', 'business_public_name'): "اسمِ مجموعه، فقط اگه خودتون بخواید",
    ('ikiku.photo', 'image'): "عکس‌هایی که گذاشتید، فقط بعد از تأیید",
    ('ikiku.photo', 'is_public'): None,
    ('ikiku.business', 'place_id'): None,
    ('ikiku.business', 'place_path'): None,
    ('ikiku.business', 'place_city_id'): None,
    ('ikiku.business', 'place_province_id'): None,
    ('ikiku.business', 'place_hint'): None,
}
