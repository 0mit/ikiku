...
PLAIN_FIELDS = {
    ...
    ('res.partner', 'place_public_id'): "شهر، یا محله اگر خودتون بخواید",
    ('res.partner', 'ikiku_show_neighbourhood'): None,
    ...
    ('ikiku.demand', 'place_public_id'): "محله یا منطقه",
    ...
    ('ikiku.business', 'place_public_id'): "محله یا منطقهٔ کافه یا رستوران",
